...
double hamilton(double u[][3], double phi[][3],double a_max, int N_max, int level)
{
    double H_a=0;
...
double hamilton_coarse(double u[][3], double phi[][3], double a_max, int N_max, int level)
{
    int N=N_max/pow(2,level);
    double a=a_max*pow(2,level);
    double H_a=0;
...
void sweep(double u[][3], double phi[][3],double a_max, int N_max, int level, double delta)
{
...
void multigrid(double u[][3], double phi[][3], double a, int N, int level, int sweep_lvl[], int gamma, int max_level, double delta)
{
    ...
    if (level< max_level)
    {
        ...
        phi_calculation(phi,u, a,N,level);
